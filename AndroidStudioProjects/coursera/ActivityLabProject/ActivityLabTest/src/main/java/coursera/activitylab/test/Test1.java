package coursera.activitylab.test;

/**
 * Created by xiaorong on 2/1/14.
 */
import com.robotium.solo.*;

import android.test.ActivityInstrumentationTestCase2;
import coursera.activitylab.ActivityOne;
...
public class Test1 extends ActivityInstrumentationTestCase2<ActivityOne> {
    ...
    public void testRun() {
        ...
        assertTrue("course.labs.activitylab.ActivityOne is not found!", solo.waitForActivity(coursera.activitylab.ActivityOne.class));
